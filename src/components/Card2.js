            ...
            <a className="cursor-pointer" onClick={()=> navigate(`/listing/${listingId}`)}>
                ...
                <div className="px-4 py-2 sm:py-4">
                    ...
                    <div className='flex items-center'>
                        ...
                        <span className="text-sm sm:text-lg font-semibold text-gray-700 mt-0 ml-1">{`- ${maticToUsd} USD`}</span>
                        <span className="text-xs sm:text-lg font-semibold text-gray-700 mt-0 ml-auto">{pair === undefined? "..." : pair}</span>
                    </div>
                </div>
            </a>
        </div>
