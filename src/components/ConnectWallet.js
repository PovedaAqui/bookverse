  ...
  return (
    <ConnectKitButton.Custom>
      {({ isConnected, show, address, truncatedAddress, ensName }) => {
        return (
          <div onClick={show} className="bg-gray-700 text-md font-sans font-semibold p-2 rounded-full cursor-pointer text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
>
